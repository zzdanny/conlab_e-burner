package tw.ntust.e_burner.component;
 ...
 * <tw.ntust.e_burner.component.RoundProgress
        ...
        eburner:max="100"
        eburner:progress="50"
        eburner:progressDrawable="@drawable/red_progress_clip"
        eburner:track="@drawable/progress_bar_fill_bg"
    />
 ...
 <tw.ntust.e_burner.component.RoundProgress
        ...
        eburner:max="100"
        eburner:progress="50"
        eburner:progressDrawable="@drawable/dark_blue_progress_clip"
        eburner:track="@drawable/progress_bar_stripes_track"
    />
...
public class RoundProgress extends RelativeLayout {
    ...
    protected void setup(Context context, AttributeSet attrs)
    {
        ...
        int trackResource = attrs.getAttributeResourceValue(xmlns, "trackInt", 0);
