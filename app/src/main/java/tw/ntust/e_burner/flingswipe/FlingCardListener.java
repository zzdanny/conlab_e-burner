package tw.ntust.e_burner.flingswipe;
...
public class FlingCardListener implements View.OnTouchListener {
    ...
    private float getScrollProgressPercent() {
        if (movedBeyondUpBorder()) {
            return -1f;
        }
        else {
            float zeroToOneValue = (aPosY + halfHeight - upBorder());
    ...
    private boolean resetCardViewOnStack() {
        if (movedBeyondUpBorder()) {
            onSelected(getExitPoint(parentHeight), 300);
            mFlingListener.onScroll(1.0f);
        } else {
            float abslMoveDistance = Math.abs(aPosY - objectY);
            aPosX = 0;
            aPosY = 0;
            aDownTouchX = 0;
            aDownTouchY = 0;
    ...
    private boolean movedBeyondUpBorder() {
        return aPosY + halfHeight < upBorder();
    }
    ...
    public void onSelected(float exitY, long duration) {
        ...
        this.frame.animate()
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        mFlingListener.upExit(dataObject);
